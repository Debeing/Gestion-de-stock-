...
?>
     ...
     <div class="form-containered">
            <div class="form">
                <form action="<?= !empty($_GET['id']) ? "../model/ajoutArticle.php" : "../model/ajoutArticle.php"?>"  method="POST">
                    <div class="contenu">
                        <div class="input">
                            <input value="<?= !empty($_GET['id']) ? $article['id'] : "" ?> " type="hidden" name="id" id="id">
                            <label for="id_article">Article<span style="color: red;">*</span></label><br>
                            <select name="id_article" id="id_article">
                                ...
                                if (!empty($articles) && is_array($articles)) {
                                    foreach($articles as $key => $value){
                                        ?>
                                        <option value="<?=$value['id']?>"><?=$value['nom_aticle']. "-". $value['quantite']. "disponible" ?></option>
                                        <?php
                                    }
                                }
                                ?>
